...
window.onload = function () {
    ...
    let hyperbolicparaboloidcount = 0;
    let hyperboliccylindercount = 0;
    let paraboliccylindercount = 0;
    let ellipticcylindercount = 0;
    let ellipticparaboloidcount = 0;
    let conecount = 0;
    let bublickcount = 0;
    let singlecavityhyperboloidcount = 0;
    let doublecavityhyperboloidcount = 0;
            ...
            if (canPrint.sphere) {
                ...
                if (canPrint.ellipsoid) {
                    ...
                    if (canPrint.hyperbolicparaboloid) {
                        if (hyperbolicparaboloidcount <= 0) {
                            SCENE.push(
                                sur.hyperbolicParaboloid())
                            hyperbolicparaboloidcount++;
                            figureON--;
                        }
                    } else {
                        hyperbolicparaboloidcount = 0;
                        if (canPrint.hyperboliccylinder) {
                            if (hyperboliccylindercount <= 0) {
                                SCENE.push(
                                    sur.hyperboliccylinder())
                                hyperboliccylindercount++;
                                figureON--;
                            }
                        } else {
                            hyperboliccylindercount = 0;
                            if (canPrint.paraboliccylinder) {
                                if (paraboliccylindercount <= 0) {
                                    SCENE.push(
                                        sur.paraboliccylinder())
                                    paraboliccylindercount++;
                                    figureON--;
                                }
                            } else {
                                paraboliccylindercount = 0;
                                if (canPrint.ellipticcylinder) {
                                    if (ellipticcylindercount <= 0) {
                                        SCENE.push(
                                            sur.ellipticcylinder())
                                        ellipticcylindercount++;
                                        figureON--;
                                    }
                                } else {
                                    ellipticcylindercount = 0;
                                    if (canPrint.ellipticparaboloid) {
                                        if (ellipticparaboloidcount <= 0) {
                                            SCENE.push(
                                                sur.ellipticparaboloid())
                                            ellipticparaboloidcount++;
                                            figureON--;
                                        }
                                    } else {
                                        ellipticparaboloidcount = 0;
                                        if (canPrint.cone) {
                                            if (conecount <= 0) {
                                                SCENE.push(
                                                    sur.cone())
                                            ...
                                            if (canPrint.bublick) {
                                                ...
                                                if (canPrint.singlecavityhyperboloid) {
                                                    if (singlecavityhyperboloidcount <= 0) {
                                                        SCENE.push(
                                                            sur.singlecavityhyperboloid())
                                                        singlecavityhyperboloidcount++;
                                                        figureON--;
                                                    }
                                                } else {
                                                    singlecavityhyperboloidcount = 0;
                                                    if (canPrint.doublecavityhyperboloid) {
                                                        if (doublecavityhyperboloidcount <= 0) {
                                                            SCENE.push(
                                                                sur.doublecavityhyperboloid())
                                                            doublecavityhyperboloidcount++;
                                                            figureON--;
                                                        }
                                                    } else {
                                                        doublecavityhyperboloidcount = 0;
                                                        if (figureON < 0) {
                                                            SCENE.pop();
                                                            figureON = 0;
                                                        }
